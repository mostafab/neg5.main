...
var player = _sql2.default.player;
...
exports.default = {
    ...
    addTournamentPlayer: function addTournamentPlayer(tournamentId, teamId, _ref, currentUser) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            (0, _db.query)(team.add.addPlayers, params, _db.queryTypeMap.one).then(function (result) {
    ...
    editPlayerName: function editPlayerName(tournamentId, playerId, name) {
        return new Promise(function (resolve, reject) {
            ...
            (0, _db.query)(player.edit, params, _db.queryTypeMap.one).then(function (result) {
                return resolve(result);
            }).catch(function (error) {
                return reject(error);
            });
    ...
    deletePlayer: function deletePlayer(tournamentId, playerId) {
        return new Promise(function (resolve, reject) {
            ...
            (0, _db.query)(player.remove, params, _db.queryTypeMap.one).then(function (result) {
                return resolve(result);
            }).catch(function (error) {
                return reject(error);
            });
