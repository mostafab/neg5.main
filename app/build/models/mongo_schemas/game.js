...
var gameSchema = new Schema({
    ...
    round: { type: Number, default: 0, set: function set(num) {
            if (num == null) {
                return 0;
            }
            return num;
        } },
    tossupsheard: { type: Number, default: 20, set: function set(tossups) {
            if (tossups == null) {
                return 20;
            }
            return tossups;
    ...
    team1: {
        team_name: String,
        team_id: String,
        score: { type: Number, default: 0, set: function set(score) {
                return score == null ? 0 : score;
            } },
        bouncebacks: { type: Number, default: 0, set: function set(bb) {
                return bb == null ? 0 : bb;
            } },
